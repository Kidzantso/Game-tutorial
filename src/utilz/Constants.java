...
public class Constants {
   ...
   public static class ObjectConstants {
		...
		public static final int BOX = 3;
                public static final int TRAPS = 4;
    ...
    public static final int healthBarX = (int)(34*Game.SCALE);
    public static final int healthBarY = (int)(14*Game.SCALE);
    
    public static final int PowerBarWidth = (int)(104*Game.SCALE);
    public static final int PowerBarHeight = (int)(2*Game.SCALE);
    public static final int PowerBarXStart = (int)(44*Game.SCALE);
    public static final int PowerBarYStart = (int)(34*Game.SCALE);
