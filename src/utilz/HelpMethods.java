...
public class HelpMethods {
    ...
    if(value>=48||value<0||value!=11 //transprent tile in the image
            )
        return true;
    ...
    public static ArrayList<Traps> GetTraps(BufferedImage img ){   
        ...
        int value = color.getBlue();
        if(value==TRAPS)
            list.add(new Traps(i*Game.TILES_SIZE,j*Game.TILES_SIZE,value));
        }
        return list;
    }
